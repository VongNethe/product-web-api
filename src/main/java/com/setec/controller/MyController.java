...
import com.setec.ProductWebApiApplication;
...
public class MyController {
    ...
    private final ProductWebApiApplication productWebApiApplication;
	/*
    ...
    MyController(ProductWebApiApplication productWebApiApplication) {
        this.productWebApiApplication = productWebApiApplication;
    }
	...
	public Object postProduct(@ModelAttribute PostProductDAO product)throws Exception {
		...
		String exstension = Objects.requireNonNull(file.getOriginalFilename());
		String fileName = UUID.randomUUID()+"-"+exstension;
	...
	public Object putProduct(@ModelAttribute PutProductDAO product)throws Exception {
		...
		if(p.isPresent()) {
			...
			return ResponseEntity.status(HttpStatus.ACCEPTED)
					.body(Map.of("message","Product id = "+id+" update successful","product",update));
		}
